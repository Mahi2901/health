...
DHTML_ProgressBar = function()
{
	...
	this._createDiv =function()
	{
		...
		if(document.getElementById("DHTMLSuite_progressBar_divs_transparentDiv")==null)
		{
	    	...
	    	this.divs_content.innerHTML = '<img src="'+themePath+'/loading-bar.gif"  style="margin: 5px 0px -8px 0px; padding: 0px;"/><H3><br>&nbsp;&nbsp;<B>'+pleaseWaitVar+'</B>&nbsp;&nbsp;</H3>';
...
Wait_ProgressBar = function()
{
	...
	this._createDiv =function()
	{
		if(document.getElementById("DHTMLSuite_progressBar_divs_transparentDiv")==null || true)
		{
			...
			this.divs_content.innerHTML = '<p class="loading_img"></p><H3 style="margin:0px 10px 10px 10px;"><B>'+waitMessage+'</B>&nbsp;&nbsp;</H3>';
	    	this.divs_content.style.zIndex=1;
	    	this.divs_content.style.position="absolute";
	    	this.divs_content.style.display="block";
	    	...
	    	//alert(bodyWidth);
	    	//alert(tmpWidth);
	    	//alert((bodyWidth - tmpWidth));
	    	//alert(Math.ceil((bodyWidth - tmpWidth) / 3));
	    	this.divs_content.style.left = (Math.ceil((bodyWidth - tmpWidth) / 3)-150) + 'px';;
